...
measureMilks.search = async function() {
  ...
  return await axios.get('https://ef6b-190-244-83-15.sa.ngrok.io/api/measuremilks')
    .then(res => res)
    .catch(error => error);
};
...
measureMilks.listMilks = async function() {
  ...
  return await axios.get('https://ef6b-190-244-83-15.sa.ngrok.io/api/measuremilks/milks')
    .then(res => res)
    .catch(error => error);
};
...
measureMilks.insert = async function(data) {
  ...
  return await axios.post('https://ef6b-190-244-83-15.sa.ngrok.io/api/measuremilks/insertmeasure',data)
    .then(res => res)
    .catch(error => error);
};
